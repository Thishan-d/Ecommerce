        ...
        <div className="flex flex-wrap mx-4">
          ...
          <div className="w-2/5 mx-0">
            <form onSubmit={handleSubmit} className="p-6 bg-white rounded shadow space-y-6">
              <h2 className="text-2xl font-bold">Add Product - Add product comparission</h2>
              ...
              {viewColorPicker &&
                <div className="mb-0">
                  <label className="block font-medium mb-1">Colors (optional)</label>
                ...
                <div>
                  ...
                  {formData.colors.length > 0 && <button
                    type="button"
